/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain-4.6-2012.11/build/objdir/temp-src/gcc-linaro-4.6-2012.11/gcc/config/arm/arm.md'.  */
